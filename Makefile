...
libbtrfs_objects = $(objects) send-stream.o send-utils.o kernel-lib/rbtree.o btrfs-list.o \
		   kernel-lib/radix-tree.o extent-cache.o extent_io.o \
		   kernel-lib/crc32c.o common/messages.o libbtrfsutil/errors.o \
		   uuid-tree.o utils-lib.o common/rbtree-utils.o libbtrfsutil/subvolume.o
